...
export {default as Badge_blue} from './badge_blue.svg';
export {default as Badge_orange} from './badge_orange.svg';
export {default as Badge_purple} from './badge_purple.svg';
